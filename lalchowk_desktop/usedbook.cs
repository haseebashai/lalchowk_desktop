                ...
                else
                {
                    ...
                    try
                    {
                     ...
                     //   supplierid = supplierlist.Text.Split(':')[0];
                        ...
                        {
                          string  cmd = "insert into products (`productid`, `supplierid`, `productname`,`tags`, `groupid`,`categoryid`,`color`, `mrp`, `price`, `dealerprice`, `stock`, `description`, `detailname1`, `detailname2`, `detailname3`, `detailname4`,`detailname5`, `detail1`, `detail2`, `detail3`, `detail4`,`detail5`,`brand`,`requeststatus`,`usedid`,`timestampp`) " +
                                "values ('" + pidtxt.Text + "','30', '" + s + "','" + s + " " + dname1.Text + " " + brandtxt.Text + " " + tagstxt.Text + "','" + gidtxt.Text + "', '" + catbox.Text + "',NULL,'" + mrptxt.Text + "','" + pricetxt.Text + "','" + dealertxt.Text + "','" + stocktxt.Text + "'," + desc + ",'" + dname1txt.Text + "','" + dname2txt.Text + "','"
                                + dname3txt.Text + "','" + dname4txt.Text + "'," + dn5 + ",'" + dname1.Text + "','" + dname2.Text + "','" + dname3.Text + "','" + dname4.Text + "'," + d5 + "," + bran + ",'Approved',"+sellidtxt.Text+ ",DATE_ADD(CURRENT_TIMESTAMP, INTERVAL 750 MINUTE))";
                            obj.nonQuery(cmd);
                            obj.closeConnection();
